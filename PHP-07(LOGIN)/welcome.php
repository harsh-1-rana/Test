      ...
      <div class="col-xl-6">
        ...
        <div class="heading">
            <img class="img1" src="head.png" alt="headerfile">
             ...
             <a href="logout.php"><h5 class="dashLogout">LOGOUT</h5></a>
             <h2 class="dashboardTitle">DASHBOARD</h2>
        </div>

<div class="dashboardtest">
<div class="container">
        
        <h3 class="dashboardText"><strong>Hey User! <br> This is your secured Personnel Space<br>We're happy to serve you!</strong></h3>
...
<?php     
        ...
        // echo "<script>alert('You were logged out and hence thrown back to login page')</script>";
