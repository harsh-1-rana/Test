...
/**
 * Access controller for the Newtask entity entity.
 *
 * @see \Drupal\newtask\Entity\NewtaskEntity.
 */
class NewtaskEntityAccessControlHandler extends EntityAccessControlHandler {
    ...
    switch ($operation) {
      ...
      case 'view':
        ...
        if (!$entity->isPublished()) {
          ...
          return AccessResult::allowedIfHasPermission($account, 'view unpublished newtask entity entities');
        }
        ...
        return AccessResult::allowedIfHasPermission($account, 'view published newtask entity entities');
      ...
      case 'update':
        ...
        return AccessResult::allowedIfHasPermission($account, 'edit newtask entity entities');
      ...
      case 'delete':
        ...
        return AccessResult::allowedIfHasPermission($account, 'delete newtask entity entities');
    }
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'add newtask entity entities');
  }
