...
use Drupal\newtask\Entity\NewtaskEntityType;


/**
 * Provides dynamic permissions for Newtask entity of different types.
 *
 * @ingroup newtask
 *
 */
class NewtaskEntityPermissions{
   ...
   *
   * @return array
   *   The NewtaskEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (NewtaskEntityType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\newtask\Entity\NewtaskEntityType $type
   *   The NewtaskEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(NewtaskEntityType $type) {
    $type_id = $type->id();
